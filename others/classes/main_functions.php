...
class setting
{
    ...
    function insert_update_delete_query($query)
    {
        $timeZone = "SET time_zone = '+05:30';";
        mysqli_query($this->connectDB(), $timeZone);
    ...
    function real_scaple_string($string)
    {
        $data = mysqli_real_escape_string($this->connectDB(), $string);
        return $data;
    }
}
